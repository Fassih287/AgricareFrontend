...
const Products = () => {
  ...
  const categories = ["All", "Grains", "Vegetable", "Fruit"];
              ...
              <div className="flex space-x-3">
                ...
                {localStorage.getItem("role") == "farmer" &&
                  localStorage.getItem("verify") == "true" && (
                    <button
                      type="button"
                      className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 w-52 h-12 relative left-64"
                      onClick={addProduct}
                    >
                      Add New Product
                    </button>
              ...
              <div className="flex justify-between">
                ...
                <div className="avatar-container">
                  <Tooltip
                    ...
                    children={
                      <div className="">
                        <RiMessage3Fill size={50} className="" />
                      </div>
                    }
                  />
                </div>
